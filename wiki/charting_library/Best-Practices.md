...
You can watch the output of our [demo data service](wiki/charting_library/https://demo_feed.tradingview.com/quotes?symbols=AAPL.md) and compare it to yours to ensure your backend behaves like it should.
