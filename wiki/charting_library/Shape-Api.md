...
1. `points` - an array with the new points for the shape. The format of each shape is the same as `points` argument from [createMultipointShape](wiki/charting_library/Chart-Methods.md#createmultipointshapepoints-options) method.
