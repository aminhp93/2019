...
Trading hours for this symbol. See the [Trading Sessions](wiki/charting_library/Trading-Sessions.md) article to learn more details.
...
Each item of an array is expected to be a string. Format is described in another [article](wiki/charting_library/Resolution.md).
