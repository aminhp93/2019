Subscription object is returned by [Chart Methods](wiki/charting_library/Chart-Methods.md). This object allows you to subscribe and unsubscribe to a chart event. It has two methods:
