:chart: All content on this page is relevant to [Trading Terminal](wiki/charting_library/Trading-Terminal.md) only.
...
Remark 1. [Broker API](wiki/charting_library/Broker-API.md) should implement [accountManagerInfo](wiki/charting_library/Broker-API.md#accountmanagerinfo)
...
The following information should be returned by [accountManagerInfo](wiki/charting_library/Broker-API.md#accountManagerInfo).
...
### account: [WatchedValue](wiki/charting_library/WatchedValue.md) of AccountInfo
...
You can display any field of an [order](wiki/charting_library/Trading-Objects-and-Constants.md#order) or add your own fields to an order object and display them.

### possibleOrderStatuses: array of [OrderStatus](wiki/charting_library/Trading-Objects-and-Constants.md#orderstatus)
...
You can display any field of a [position](wiki/charting_library/Trading-Objects-and-Constants.md#position) or add your own fields to a position object and display them.
...
1. `changeDelegate` : [Delegate](wiki/charting_library/Delegate.md)
