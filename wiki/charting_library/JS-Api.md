...
If no symbols are found, then callback should be called with an empty array. See more details about `ticker` value [here](wiki/charting_library/Symbology.md#ticker)
