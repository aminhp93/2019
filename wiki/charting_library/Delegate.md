Delegate is an object that is used in the [Account Manager](wiki/charting_library/Account-Manager.md) to notify about events happening with orders, positions and other information displayed in the tables.
